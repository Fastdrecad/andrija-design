...
const LogoM = ({ className, background }) => {
  return (
    <svg x="100px" y="100px" viewBox="0 0 119.6 86" style={{ background }}>
      <path
        className={className}
        d="M89.4,19.1l18.2,54.6c2.9,8.6,6,9.9,11.9,9.9V86H84.1v-2.3c6,0,13.5,1.3,10.7-9.4L76.7,21L56.2,86h-1.9
